...
public class WorkbookWriterTest {
  ...
  public void testAllPublicMethodsNPE() throws Exception {
    new NullPointerTester().ignore(WorkbookWriter.class.getDeclaredMethod("equals", Object.class))
  ...
  public void testSetSheetName() {
    ...
    assertEquals(ra("NewSheet"), writer.setSheetName("NewSheet").getAllSheetNames());
  }
  ...
  public void testCreateSheetException() {
    assertThrows("Sheet name is already existed", IllegalArgumentException.class, () -> {
      writer.createSheet("test");
      writer.createSheet("test");
    });
  }
  ...
  public void testAddRowWithDouble() {
    ...
    assertEquals("2.1454", writer.toReader().withoutHeader().toLists().iterator().next().get(0));
  }
  ...
  public void testSave() throws InvalidFormatException, IOException {
    ...
    WorkbookReader reader =
        WorkbookReader.open(RubyFile.join(BASE_DIR, "test.xls")).withoutHeader();
  ...
  public void testEquality() {
    new EqualsTester().addEqualityGroup(writer, new WorkbookWriter(), new WorkbookWriter())
        .testEquals();
  }
  ...
  public void testUnequality() {
    ...
    assertNotEquals(writer.hashCode(), new WorkbookWriter().addRow("123").hashCode());
  }

  @Test
  public void testToString() {
    assertEquals(MoreObjects.toStringHelper(WorkbookWriter.class)
        .addValue(writer.toReader().toMultimap()).toString(), writer.toString());
  }
